  ...
  return (
    <main className="min-h-screen flex flex-col relative">
      ...
      <div className="absolute top-0 right-0 p-6 flex gap-4 z-10">
        <Link href="/login" className="text-slate-300 hover:text-white font-medium px-4 py-2">
          Log in
        </Link>
        <Link href="/register" className="bg-court-600 hover:bg-court-500 text-white font-medium px-5 py-2 rounded-lg transition">
          Sign up
        </Link>
      </div>
